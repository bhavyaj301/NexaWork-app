        ...
        <div className="page-col flex flex-col items-center text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 w-full sm:w-auto mb-12">
            <button
              ...
              className="azure-btn-primary px-7 py-3 text-xs sm:text-sm font-bold flex items-center justify-center gap-2.5 w-full sm:w-auto shadow-xl shadow-blue-600/35 hover:scale-105 active:scale-95 transition-all"
            >
            ...
            <button
              ...
              className="azure-btn-secondary px-7 py-3 text-xs sm:text-sm font-bold flex items-center justify-center gap-2.5 w-full sm:w-auto hover:scale-105 active:scale-95 transition-all backdrop-blur-md"
            >
              <BookOpen className="w-4 h-4 text-emerald-400" />
              <span>AI Resume Analyzer & Matcher</span>
            </button>
          </div>
            ...
            <div className="saas-hero-mockup p-5 sm:p-7 rounded-2xl text-left border border-[var(--border-color)] antigravity-gradient-border shadow-2xl backdrop-blur-xl">
              ...
              {mockupTab === 'trends' && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { label: 'GenAI Surge', value: '+184% YoY', sub: 'OpenAI & Semantic Models', vc: 'text-[var(--text-primary)]', sc: 'text-sky-400' },
                    { label: 'Avg Cloud Base', value: '$178,500', sub: '+9.2% above general tech', vc: 'text-emerald-400', sc: 'text-emerald-400/90' },
                    { label: 'Remote Share', value: '82.6%', sub: '44% Hybrid · 38% Full Remote', vc: 'text-purple-400', sc: 'text-purple-400/90' },
                  ].map(s => (
